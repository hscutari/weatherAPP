 ...
 */
class LocationRequestWrapper (private val activity: Activity, private val onLocationListener: OnLocationListener?) :
        LocationListener,
    ...
    override fun onConnected(bundle: Bundle?) {
        if (checkSelfPermission(activity, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(activity, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            return
        }
